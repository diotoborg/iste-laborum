...
![Health Check](https://github.com/diotoborg/iste-laborum/workflows/Health%20Check/badge.svg)
...
```
$ npm install --save @diotoborg/iste-laborum
```
...
import from `@diotoborg/iste-laborum/immutable`.

```js
import vitruvius from '@diotoborg/iste-laborum';
...
2.0](https://github.com/diotoborg/iste-laborum/blob/master/LICENSE.txt).

## Code of Conduct
This project adheres to the [American Express Community Guidelines](https://github.com/diotoborg/iste-laborum/wiki/Code-of-Conduct).
